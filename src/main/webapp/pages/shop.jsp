            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center gap-lg-3">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="/pages/shop.html">Cửa hàng</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu border-0 shadow rounded-3" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="../pages/wishList.html">Danh sách sản phẩm yêu
                                        thích</a></li>
    ...
    <main class="shop-page">
        ...
        <section class="arrivals section-padding">
            ...
            <div class="na-grid">
                ...
                <a class="na-card card-soft soft-hover" href="/pages/product-detail.html">
                    <img src="https://lapvip.vn/upload/products/original/samsung-galaxy-ring-1737447949.jpg" alt="">
                    <span class="na-tag">NEW</span>
                    <h4>TechX Ring Mini 2</h4>
                    <p>17.900.000 VND</p>
                </a>

                <a class="na-card card-soft soft-hover" href="/pages/product-detail.html">
                    <img src="https://i.redd.it/gundam-astray-red-frame-big-arm-v0-tobgooxwp43b1.jpg?width=3220&format=pjpg&auto=webp&s=1fd4c4325eeb169ffd9b634d28649e686ae2f58b"
                        alt="">
                    <span class="na-tag">NEW</span>
                    <h4>Đèn decor dáng robot</h4>
                    <p>12.900.000 VND</p>
                </a>

                <a class="na-card card-soft soft-hover" href="/pages/product-detail.html">
                    <img src="https://mekongasean.vn/stores/news_dataimages/2025/062025/27/14/in_article/a2-1750992794-7589-175099295920250627141114.jpg?rt=20250627141606"
                        alt="">
                    <span class="na-tag">NEW</span>
                    <h4>Kính dịch thuật AI</h4>
                    <p>5.990.000 VND</p>
                </a>

                <div class="na-card card-soft soft-hover">
                    <img src="https://lagihitech.vn/wp-content/uploads/2022/08/may-chieu-mini-BeeCube-X2-Max-hinh-6.jpg"
                        alt="">
                    <span class="na-tag">NEW</span>
                    <h4>Máy chiếu mini Capsule Max</h4>
                    <p>7.290.000 VND</p>
                </div>
        ...
        <section class="blog-preview section-padding">
            <div class="container">
                ...
                <div class="blog-grid">
                    ...
                    <a href="blog.html" class="blog-card card-soft soft-hover">
        ...
        <section class="recommended section-padding">
            <h2 class="section-title">Được đề xuất cho bạn</h2>
            ...
            <div class="carousel-wrapper">
                ...
                <div class="carousel-track d-flex">
                    ...
                    <div class="product-card p-3 bg-white card-soft soft-hover">
                        <img src="https://cdn.stereo.vn/uploads/2016/01/Canon-C-10W-100.jpg">
                        <h6 class="fw-semibold mt-2">Pocket Projector – Hình ảnh trong lòng bàn tay</h6>
                        <p class="fw-bold text-dark">3.490.000 VND</p>
                    </div>

                    <div class="product-card p-3 bg-white card-soft soft-hover">
                        <img
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0Gv9yE3KUbYyuvPN4aTJpKXv2vfrO0vv76g&s">
                        <h6 class="fw-semibold mt-2">Console mini – Chơi mọi lúc</h6>
                        <p class="fw-bold text-dark">1.590.000 VND</p>
                    </div>

                    <div class="product-card p-3 bg-white card-soft soft-hover">
                        <img
                            src="https://vn-test-11.slatic.net/original/cf9ef55da28d9878914dce5690b3f236.jpg_500x500Q80.jpg">
                        <h6 class="fw-semibold mt-2">Loa mini AI – Gọn, mạnh, độc</h6>
                        <p class="fw-bold text-dark">790.000 VND</p>
                    </div>

                    <div class="product-card p-3 bg-white card-soft soft-hover">
                        <img
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR20NrMu4x4Q8fUBzqHX04Ru5puEnoQSxV6oQ&s">
                        <h6 class="fw-semibold mt-2">Đèn AI tự động nhận diện</h6>
                        <p class="fw-bold text-dark">1.290.000 VND</p>
                    </div>

                    <div class="product-card p-3 bg-white card-soft soft-hover">
                        <img id="img-air-gesture">
                        <h6 class="fw-semibold mt-2">Bộ điều khiển cử chỉ AI</h6>
                        <p class="fw-bold text-dark">2.690.000 VND</p>
                    </div>
